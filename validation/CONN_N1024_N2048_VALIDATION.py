"""
================================================================================
CONN ULTRA-SCALE VALIDATION — N=1024, N=2048
================================================================================

Companion to CONN_VALIDATION_V5.py and CONN_LARGE_SCALE_VALIDATION.py.
Tests scaling behavior at N=1024 and N=2048.

Same corrected protocol:
  λ = 0.5 (annealed 0 → 0.5)
  η_φ = 0.02, η_A = 0.03, β = 1.0
  400 integration steps
  30% bit-flip + σ=0.5 Gaussian jitter
  Real Hopfield baseline: sign(J·s) with 200 max steps

Expected runtime: ~2-4 hours on Colab (GPU not required)

Results reproduced in this script:
  N=1024: Hopfield M=124 (α=0.121), CONN M=195 (α=0.190), ratio=1.57×
  N=2048: Hopfield M=238 (α=0.116), CONN M=390 (α=0.190), ratio=1.64×
...
if __name__ == "__main__":
    print("=" * 90)
    print("CONN vs Hopfield Capacity Test - Ultra Scale (N=1024, N=2048)")
        ...
        for M in range(1, max_M + 1):
            ...
            for trial in range(trials):
                ...
                for mu in range(min(M, test_patterns_per_trial)):
                    rng = np.random.RandomState(trial * 1000 + mu)
